...
class ThermalTime:
    ...
    def __init__(self, start_year, start_month, start_day, station_name, station_code, Tb, theta):
    ...
    def output_days(self):
        ...
        self.old_x = 1
        while True:
            self.new_x = self.old_x - f_x(self.n, self.old_x, self.x, yint, self.f, self.theta) / f_1x(self.old_x, self.f)
